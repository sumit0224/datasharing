...
function ActiveCallView() {
    ...
    if (callState !== 'connecting' && callState !== 'active') return null;
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black">
            ...
            <div className="relative w-full h-full">
                ...
                {localStream && (
                    <div className="absolute top-24 right-6 w-40 h-32 rounded-2xl overflow-hidden shadow-2xl border-2 border-white/20 bg-gray-900">
                        {isVideoOff ? (
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-8">
                    <div className="flex items-center justify-center gap-4">
                        ...
                        <button
                            onClick={toggleMute}
                            className={`w-14 h-14 rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95 ${isMuted
                        ...
                        <button
                            ...
                            className="w-16 h-16 rounded-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95 shadow-lg shadow-red-500/50"
                            title="End Call"
                        >
                        ...
                        <button
                            onClick={toggleVideo}
                            className={`w-14 h-14 rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95 ${isVideoOff
                                    ? 'bg-red-500 hover:bg-red-600'
                                    : 'bg-white/20 hover:bg-white/30 backdrop-blur-sm'
                                }`}
